...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:web'],function () {
    ...
    Route::get('requisition/report',[RequisitionController::class,'report'])->name('requisition.report');
    Route::get('requisition/delivery-confirm/data',[RequisitionController::class,'deliveryConfirm'])->name('requisition.delivery.confirm');
