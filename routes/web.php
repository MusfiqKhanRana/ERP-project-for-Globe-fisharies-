...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:web'],function () {
    ...
    Route::post('/production/chill-room/return_item_process',[ChillStorageController::class,'return_item_process'])->name('production.chill_room.return_item_process');
    ...
    Route::get('packing/list/approved/{id}',[PackingListController::class,'packing_list'])->name('packing.list.approve');
