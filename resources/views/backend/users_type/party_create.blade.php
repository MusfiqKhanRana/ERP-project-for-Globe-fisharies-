                        ...
                        <div class="col-md-12 ">
                            <div class="portlet-body">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Party Name<span class="required">* </span></label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="party_s_name" placeholder="Party Short Name" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>
