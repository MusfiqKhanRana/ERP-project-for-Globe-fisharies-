                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td> <input class="form-control" name="spc" placeholder="result..." type="text"></td>
                                </tr>
                                <tr>
                                    <td>02.</td>
                                    <td>Coliform/gm</td>
                                    <td>Less than 100</td>
                                    <td> <input class="form-control" name="coliform" placeholder="result..." type="text"></td>
                                </tr>
                                <tr>
                                    <td>03.</td>
                                    <td>Faecal Coliform/E. coli/gm</td>
                                    <td>Less than 05</td>
                                    <td> <input class="form-control" name="faecal_coliform" placeholder="result..." type="text"></td>
                                </tr>
                                <tr>
                                    <td>04.</td>
                                    <td>Staphylococcus aureus/gm</td>
                                    <td>50</td>
                                    <td> <input class="form-control" name="staphylococcus_aureus" placeholder="result..." type="text"></td>
                                </tr>
                                <tr>
                                    <td>05.</td>
                                    <td>Salmonella/25gm</td>
                                    <td>Absent</td>
                                    <td> <input class="form-control" name="salmonella" placeholder="result..." type="text"></td>
                                </tr>
                                <tr>
                                    <td>06.</td>
                                    <td>Vibrio Cholerae/25 gm</td>
                                    <td>Absent</td>
                                    <td> <input class="form-control" name="vibrio_cholerae" placeholder="result..." type="text"></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" name="remark" id="" cols="60" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 control-label">9.Overall Remarks :</span></label>
                            <div class="col-md-6">
                                <textarea class="form-control" name="overall_remarks" id="" cols="60" rows="5"></textarea>
                            </div>
                        </div><br><br>
