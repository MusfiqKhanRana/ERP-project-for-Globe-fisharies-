                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label class="control-label" for="product">Buyer Code <span class="required">* </span></label>
                                                        <input type="text" class="form-control" name="" placeholder="Buyer Code" required>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="control-label" for="product">Buyer Name <span class="required">* </span></label>
                                                        <input type="text" class="form-control" name="" placeholder="Buyer Name" required>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="product">Buyer Address <span class="required">* </span></label>
                                                        <input type="text" class="form-control" name="" placeholder="Buyer Address" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label class="control-label" for="product">Contact Number <span class="required">* </span></label>
                                                        <input type="text" class="form-control" name="">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="product">Email <span class="required">* </span></label>
                                                        <input type="text" class="form-control" name="" placeholder="Email" required>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="control-label" for="product">Buyer Country <span class="required">* </span></label>
                                                        <select class="form-control country" name="" id="country">
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label class="control-label" for="product">Name <span class="required">* </span></label>
                                                        <input type="text" class="form-control" name="" placeholder="Name" required>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="control-label" for="product">Address <span class="required">* </span></label>
                                                        <input type="text" class="form-control" name="" placeholder="Address" required>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="product">Contact Number <span class="required">* </span></label>
                                                        <input type="number" class="form-control" name="" placeholder="Contact Number" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label class="control-label" for="product">Email <span class="required">* </span></label>
                                                        <input type="text" class="form-control" name="" placeholder="Email" required>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="control-label" for="product">Country <span class="required">* </span></label>
                                                        <select class="form-control country" name="" id="country">
                                                        </select>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-group" style="padding:2%">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Bank Name" id="bank_name" name="">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="control-label" for="a_c_name">A/C Name <span class="required">* </span></label>
                                                <input type="text" class="form-control" placeholder="A/C Name" id="a_c_name" name="">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="control-label" for="a_C_no">A/C No. <span class="required">* </span></label>
                                                <input type="number" class="form-control" placeholder="A/C No." id="a_C_no" name="">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="control-label" for="branch">Branch <span class="required">* </span></label>
                                                <input type="text" class="form-control" placeholder="Branch" id="branch" name="">
                                            </div>
                                            <div class="col-md-2">
