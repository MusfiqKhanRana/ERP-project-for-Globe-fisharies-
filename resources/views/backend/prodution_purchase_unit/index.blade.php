    ...
    <div class="portlet-body">
        <div class="table-scrollable">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    @foreach($procution_purchase_units as $key=> $data)
                        <tr id="row1">
                            <td>{{ $procution_purchase_units->firstItem() + $key }}</td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer " >
                                        ...
                                        <div class="caption pull-right">
                                            <form action="{{route('procution-purchase-units.destroy',[$data->id])}}" method="POST">
                                                @method('DELETE')
                                                @csrf
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" role="form" method="post" action="{{route('procution-purchase-units.update', $data->id)}}">
                                            {{csrf_field()}}
                                            {{method_field('put')}}
            ...
            <div class="row">
                ...
                {{ $procution_purchase_units->links('vendor.pagination.custom') }}
            </div>
        </div>
    </div>
