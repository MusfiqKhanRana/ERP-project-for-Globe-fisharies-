    ...
    <div class="page-content-wrapper">
        ...
        <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title bold">Stock Product List
                ...
                <a class="btn blue-ebonyclay pull-right" data-toggle="modal" href="#warehouse">
                    Create Warehouse
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($warehouse as $key => $data)
                                    ...
                                    <div id="addproductModal{{$data->id}}" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                                        {{csrf_field()}}
                                        <input type="hidden" value="" id="addproduct">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    {{-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button> --}}
                                                    <h2 class="modal-title" style="color: blue;">Add new Product</h2>
                                                </div>
                                                <div class="modal-body">
                                                    <form class="form-horizontal" role="form" method="post" action="{{route('product.stock.store')}}">
                                                        {{csrf_field()}}
                                                        <input type="hidden" value="{{$data->id}}" name="warehouse_id">
