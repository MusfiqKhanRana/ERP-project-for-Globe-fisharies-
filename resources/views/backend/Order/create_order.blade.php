...
@section('main-content')
    ...
    <div class="page-content-wrapper">
        ...
        @endif
        <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title bold"> Create Order
            ...
            <div class="portlet box yellow-gold">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-edit"></i>Add New Order
                    </div>
                    <div class="tools">
                    </div>
                </div>
                ...
                <div class="portlet-body form">
                    ...
                    <form method="POST" action="{{route('sale.product')}}" accept-charset="UTF-8" class="form-horizontal form-bordered">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" class="demo-loading-btn btn yellow-gold col-md-12"><i class="fa fa-check"></i> Submit Order</button>
                                </div>
                            </div>
                        </div>
                    </form>
