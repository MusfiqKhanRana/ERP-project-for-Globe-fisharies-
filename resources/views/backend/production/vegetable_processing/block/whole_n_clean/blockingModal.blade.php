<div id="whole_n_clean_blockingModal" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" role="form" method="post" action="{{route('production.other_processing.vegetable.blocking_to_blockcounter')}}">
                {{csrf_field()}}
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover block_table">
                            <thead>
                                <tr>
