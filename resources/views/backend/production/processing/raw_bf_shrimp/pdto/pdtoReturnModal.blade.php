<div id="pdtoReturnModal" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
            <form class="form-horizontal" role="form" method="post" action="{{route('production.processing-unit.block_randw')}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover pdto_block_randw_table">
                            <thead>
                                <tr>
