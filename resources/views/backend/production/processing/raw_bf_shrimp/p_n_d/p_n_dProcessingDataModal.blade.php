        ...
        <div class="modal-content">
            <form class="form-horizontal" role="form" method="post" action="{{route('production.processing-unit.processing')}}">
                ...
                <div class="modal-header"  style="background-color: #36C6D3;text-align:center;">
                    ...
                    <h2 class="modal-title" style="color: rgb(75, 65, 65);">P&D WEIGHT</h2>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="number" step='0.01' class="form-control initial_weight" name="initial_weight" placeholder="Type Weight">
                        </div>
                        <div class="col-md-3">
