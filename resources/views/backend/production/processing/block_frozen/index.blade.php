                ...
                success:function(data){
                    ...
                    $.each( data, function( key, product ) {
                        ...
                        if (product.status == "Initial") {
                            $("table#whole_table tr").last().after("<tr id='"+key+"'><td>"+product.requisition_code+"</td><td>"+product.production_processing_item.name+"</td><td>"+product.production_processing_item.grade.name+"</td><td>"+total_quantity+"kg</td><td><button style='margin-bottom:3px' data-ppu_id='"+product.id+"' data-invoice='"+product.requisition_code+"' data-item='"+product.production_processing_item.name+"' data-qty='"+total_quantity+"' data-toggle='modal' href='#processData' class='btn btn-success processing'><i class='fa fa-refresh' aria-hidden='true'></i> Processing Data</button></td></tr>");
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $.each( data, function( key, product ) {
                            ...
                            total_quantity = alive_quantity+dead_quantity;
                            if (product.status == "Initial") {
                                $("table#clean_table tr").last().after("<tr id='"+key+"'><td>"+product.requisition_code+"</td><td>"+product.production_processing_item.name+"</td><td>"+product.production_processing_item.grade.name+"</td><td>"+total_quantity+"kg</td><td><button style='margin-bottom:3px' data-ppu_id='"+product.id+"' data-invoice='"+product.requisition_code+"' data-item='"+product.production_processing_item.name+"' data-qty='"+total_quantity+"' data-toggle='modal' href='#processData_b' class='btn btn-success processing'><i class='fa fa-refresh' aria-hidden='true'></i> Processing Data</button></td></tr>");
                                // $('.fillet_invoice').html(product.requisition_code);
                                // $('.fillet_item').html(product.production_processing_item.name);
                                // $('.fillet_qty').html(total_quantity);
                                $('.processing').click(function () {
                            ...
                            if (product.status == "Blocking") {
                                ...
                                $('.blocking').click(function () {
                                    ...
                                    $('.add_btn').click(function () {
                                        ...
                                        $.each( product_array, function( key, product ) {
                                            if (product.status == "stay") {
                                                $("table.clean_block_table tr").last().after("<tr class='delete"+key+"'><td>"+product.block_name+"</td><td>"+product.block_size_name+"</td><td><button class='btn btn-danger delete' data-id='"+key+"'>Delete</button></td></tr>");
                                            }
                                        });
                                        $(".inputs").val('');
                                        $(".inputs").val(JSON.stringify(product_array));
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $.each( data, function( key, product ) {
                            ...
                            total_quantity = alive_quantity+dead_quantity;
                            if (product.status == "Initial") {
                                $("table#slice_table tr").last().after("<tr id='"+key+"'><td>"+product.requisition_code+"</td><td>"+product.production_processing_item.name+"</td><td>"+product.production_processing_item.grade.name+"</td><td>"+total_quantity+"kg</td><td><button style='margin-bottom:3px' data-ppu_id='"+product.id+"' data-invoice='"+product.requisition_code+"' data-item='"+product.production_processing_item.name+"' data-qty='"+total_quantity+"' data-toggle='modal' href='#processData_c' class='btn btn-success processing'><i class='fa fa-refresh' aria-hidden='true'></i> Processing Data</button></td></tr>");
                                // $('.fillet_invoice').html(product.requisition_code);
                                // $('.fillet_item').html(product.production_processing_item.name);
                                // $('.fillet_qty').html(total_quantity);
                                $('.processing').click(function () {
                            ...
                            if (product.status == "Blocking") {
                                ...
                                $('.blocking').click(function () {
                                    ...
                                    $('.add_btn').click(function () {
                                        ...
                                        $.each( product_array, function( key, product ) {
                                            if (product.status == "stay") {
                                                $("table.slice_block_table tr").last().after("<tr class='delete"+key+"'><td>"+product.block_name+"</td><td>"+product.block_size_name+"</td><td><button class='btn btn-danger delete' data-id='"+key+"'>Delete</button></td></tr>");
                                            }
                                        });
                                        $(".inputs").val('');
                                        $(".inputs").val(JSON.stringify(product_array));
