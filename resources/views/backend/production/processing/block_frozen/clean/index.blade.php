<div class="tab-pane" id="tab_b">
    ...
    <hr>
    <table class="table table-striped table-bordered table-hover" id="clean_table">
        <thead>
            <tr>
                <th>
                    Invoice No.
        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <button style="margin-bottom:3px" data-toggle="modal" href="#blocking_b" class="btn btn-success"><i class="fa fa-bar-chart" aria-hidden="true"></i> Bloicking</button>
                    ...
                    <button style="margin-bottom:3px" data-toggle="modal" href="#excessVolume_b" class="btn btn-warning"><i class="fa fa-refresh" aria-hidden="true"></i> Excess Volume</button>
