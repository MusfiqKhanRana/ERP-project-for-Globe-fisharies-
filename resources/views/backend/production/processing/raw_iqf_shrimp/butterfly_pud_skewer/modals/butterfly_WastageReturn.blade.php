        ...
        <div class="modal-content">
            <form class="form-horizontal" role="form" method="post" action="{{route('production.processing-unit.randw')}}">
                ...
                <div class="modal-header"  style="background-color: #36C6D3;text-align:center;">
                    ...
                    <h2 class="modal-title" style="color: rgb(75, 65, 65);"> Wastage & Return (Butterfly/PUD Skewer)</h2>
                </div>
                <div class="modal-body">
                    ...
                    {{-- <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover butterfly_randw_table">
                            <thead>
                                <tr>
                                    <th>
                                        Grading 
