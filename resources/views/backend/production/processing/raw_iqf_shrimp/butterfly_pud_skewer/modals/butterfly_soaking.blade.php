        ...
        <div class="modal-content">
            <form class="form-horizontal" role="form" method="post" action="{{route('production.processing-unit.soaking_to_glazing')}}">
                ...
                <div class="modal-header"  style="background-color: #36C6D3;text-align:center;">
                    ...
                    <h2 class="modal-title" style="color: rgb(75, 65, 65);">Soaking (Butterfly/PUD Skewer)</h2>
                </div>
                ...
                {{-- <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover butterfly_soaking_table">
                            <thead>
                                <tr>
                                    <th>
                                        Grade
