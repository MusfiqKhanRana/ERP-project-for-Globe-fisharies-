                            ...
                            $('.block_counter').click(function () {
                                ...
                                $.ajax({
                                    ...
                                    success:function(data){
                                        ...
                                        $("table.block_counter_table_hoso tbody tr").empty();
                                        $.each( data, function( key, product ) {
                                            $("table.block_counter_table_hoso tr").last().after("<tr id='"+key+"'><td>"+product.block_name+" kg</td><td>"+product.block_size+"</td><td><input type='number' class='form-control' name='block_quantity[]' placeholder='Block Quantity'><input type='hidden' name='item_id[]' value='"+product.id+"'></td></tr>");
                                        });
                                    }
                                });
                            });
                            ...
                            $('.excess_volume').click(function () {
                                ...
                                $.ajax({
                                    ...
                                    success:function(data){
                                        ...
                                        $("table.excess_volume_table_hoso tbody tr").empty();
                                        $.each( data, function( key, product ) {
                                            $("table.excess_volume_table_hoso tr").last().after("<tr id='"+key+"'><td>"+product.block_name+" kg</td><td>"+product.block_size+"</td><td>"+product.block_quantity+"</td><td><input type='number' class='form-control' name='excess_volume[]' placeholder='excess volume'><input type='hidden' name='item_id[]' value='"+product.id+"'></td></tr>");
                                        });
                                    }
                                });
                            });
                                ...
                                $('.block_counter').click(function () {
                                    ...
                                    $.ajax({
                                        ...
                                        success:function(data){
                                            ...
                                            $("table.block_counter_table_hoto tbody tr").empty();
                                            $.each( data, function( key, product ) {
                                                $("table.block_counter_table_hoto tr").last().after("<tr id='"+key+"'><td>"+product.block_name+" kg</td><td>"+product.block_size+"</td><td><input type='number' class='form-control' name='block_quantity[]' placeholder='Block Quantity'><input type='hidden' name='item_id[]' value='"+product.id+"'></td></tr>");
                                            });
                                        }
                                    });
                                });
                                ...
                                $('.excess_volume').click(function () {
                                    ...
                                    $.ajax({
                                        ...
                                        success:function(data){
                                            ...
                                            $("table.excess_volume_table_hoto tbody tr").empty();
                                            $.each( data, function( key, product ) {
                                                $("table.excess_volume_table_hoto tr").last().after("<tr id='"+key+"'><td>"+product.block_name+" kg</td><td>"+product.block_size+"</td><td>"+product.block_quantity+"</td><td><input type='number' class='form-control' name='excess_volume[]' placeholder='excess volume'><input type='hidden' name='item_id[]' value='"+product.id+"'></td></tr>");
                                            });
                                        }
                                    });
                                });
