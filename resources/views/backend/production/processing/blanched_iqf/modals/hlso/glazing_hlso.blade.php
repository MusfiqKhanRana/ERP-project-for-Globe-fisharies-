<div id="glazing_hlso" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" role="form" method="post" action="{{route('production.processing-unit.glazing_to_randw')}}">
                ...
                {{-- <div class="col-md-12">
                    <table class="table table-striped table-bordered table-hover hlso_easy_peel_glazing_table">
                        <thead>
                            <tr>
                                <th>
                                    Grade
