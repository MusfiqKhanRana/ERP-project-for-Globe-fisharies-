        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <button style="margin-bottom:3px" data-toggle="modal" href="#whole_guttedCleanModal" class="btn btn-warning"><i class="fa fa-refresh" aria-hidden="true"></i> Gutted Clean</button>
                    ...
                    <button style="margin-bottom:3px" data-toggle="modal" href="#whole_guttedReturnModal" class="btn btn-danger"><i class="fa fa-repeat" aria-hidden="true"></i> Return & Wastage</button>
                </td>
            </tr>
        </tbody>
    </table>
