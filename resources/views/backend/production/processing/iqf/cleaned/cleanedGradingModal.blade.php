<div id="cleanedGradingModal" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
            ...
            <form class="form-horizontal" role="form" method="post" action="{{route('production.processing-unit.grading_to_glazing')}}">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <br><br>
                        <div class="col-md-12">
                            <table class="table table-striped table-bordered table-hover cleaned_grading_table">
                                <thead>
                                    <tr>
                                        <th>
                                            Grade
