<div id="sliced_fmlyCLeaningModal" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
    {{csrf_field()}}
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-9">
                                    <label>Cleaning Weight</label>
                                    <input type="text" class="form-control" placeholder="Type Clean Weight">
                                </div>
