        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <button style="margin-bottom:3px" data-toggle="modal" href="#sliced_chineseReturnModal" class="btn btn-danger"><i class="fa fa-repeat" aria-hidden="true"></i> Return</button>
                </td>
            </tr>
            <tr>
                <td>
