<div id="butter_flyReturnModal" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
            ...
            <form class="form-horizontal" role="form" method="post" action="{{route('production.processing-unit.randw')}}">
                ...
                <div class="modal-body">
                    <div class="row" style="margin: 3%" >
                        ...
                        <p><b>Invoice no:</b> <span class="butter_fly_invoice"></span></p>
                        <p><b>Item Name:</b> <span class="butter_fly_item"></span></p>
                        <p><b>Quantity:</b> <span class="butter_fly_qty"></span></p>
                    </div>
                    ...
                    <div class="row" style="text-shadow: -1px 0 #013B45, 0 1px #013B45, 1px 0 #013B45, 0 -1px #013B45;background-color:#05575B;color:white;margin-bottom:2%;">
                        <div class="col-md-6">
                    ...
                    {{-- <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover butter_fly_randw_table">
                            <thead>
                                <tr>
                                    <th>
                                        Grading 
