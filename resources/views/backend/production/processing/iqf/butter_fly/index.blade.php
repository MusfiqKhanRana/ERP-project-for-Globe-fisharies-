        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <button style="margin-bottom:3px" data-toggle="modal" href="#butter_flyReturnModal" class="btn btn-danger"><i class="fa fa-repeat" aria-hidden="true"></i> Return</button>
                </td>
            </tr>
            <tr>
                <td>
