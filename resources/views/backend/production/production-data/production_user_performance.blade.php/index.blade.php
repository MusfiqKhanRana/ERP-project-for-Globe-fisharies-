                    ...
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="{{route('user-performance.store')}}">
                            ...
                            <div class="form-group" style="padding:2%">
                                <label for="inputEmail1" class="col-md-2 control-label">Add Performance Info</label>  
                                <div class="row">
                                    <div class="col-md-3">
                                        <input type="time" class="form-control" placeholder="Time" id="start_time" name="start_time">
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control" placeholder="C.Temp" id="end_time" name="end_time">
                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control" placeholder="F.M.R" id="quantity" name="quantity">
                                    </div>
                                    <div class="col-md-2">
