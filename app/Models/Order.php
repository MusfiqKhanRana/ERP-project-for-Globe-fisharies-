...
class Order extends Model
{
    ...
    {
        return $this->belongsToMany(Product::class,'product_orders','order_id','product_id')->withPivot('id','quantity','discount_in_amount','discount_in_percentage','selling_price');
    }
